...
const featuresData = [
    {
        ...
        image: 'https://img.freepik.com/premium-photo/excited-young-asian-woman-playing-online-game-smartphone-with-fists-clenched-celebrating-victory-expressing-success_2034-3144.jpg?w=996',
    ...
    },
    {
        ...
        image: 'https://img.freepik.com/free-photo/close-up-hand-holding-firework-concert_23-2149162981.jpg?t=st=1744445969~exp=1744449569~hmac=7585ec4e085f12066b0e9fa5f65ec7d71df0b6c15487727d73a01b9c2d291207&w=996',
    ...
    },
    {
        ...
        image: 'https://img.freepik.com/premium-photo/low-angle-view-woman-holding-umbrella_1048944-9515710.jpg?w=740',
      ...
      <nav className="navbar">
        ...
        <div className="left-block">
          ...
          <ul className={`nav-links ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
            ...
            <li><Link to="/explore" onClick={() => setIsMobileMenuOpen(false)}>Explore Events</Link></li>
